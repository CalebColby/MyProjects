...
# note how the body of the functino will be indented
...
# Passing a other types as an argument
...
# Global variables
# You can designate a variable initialized outside of a functino 
# to be used globally inside the function with the global key word
